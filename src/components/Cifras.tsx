...
import GigLayout from '../components/GigLayout.tsx';
// resto do código...

// textarea com /* @ts-ignore */
{/* @ts-ignore */}
<textarea 
  className="w-full h-48 bg-slate-900/50 border border-slate-600 hover:border-slate-400 focus:border-amber-400 text-slate-200 p-4 font-mono rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-amber-400/50 transition-all"
/>
